...
void init(Scene& scene)
{
  ...
  auto& skybox_pipeline = SkyboxPipeline::get_singleton();

  auto image_data = asset_manager.load_image("assets/texture/grid-texture.jpg", "grid");
  skybox_pipeline.set_skybox_image(image_data->image);
